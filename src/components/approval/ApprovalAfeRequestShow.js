                    ...
                    <div className="container">
                        ...
                        <div className='row afe-show-tabs d-flex align-items-center mb-3'>
                            <div className='col-sm-8'>
                                <a className='afe-show-tab mx-1 active'>All</a>
                                <a className='afe-show-tab mx-2 inactive'>Pending</a>
                                <a className='afe-show-tab mx-2 inactive'>Approved</a>
                                <a className='afe-show-tab mx-2 inactive'>Rejected</a>
                                <a className='afe-show-tab mx-2 inactive'>Cancelled</a>
                                <a className='afe-show-tab mx-2 inactive'>On Hold</a>
                            </div>
                            <div className='col-sm-4'>
...
ApprovalAfeRequestShow.propTypes = {
...
export default connect(mapStateToProps, { setUserType })(ApprovalAfeRequestShow);
