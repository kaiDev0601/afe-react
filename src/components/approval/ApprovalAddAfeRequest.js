            ...
            <div className="row flex-nowrap">
                ...
                <div className="col-md-9 col-xl-10 page-container">
                    ...
                    <div className='aafe-container'>
                        ...
                        { afeRequestStep === 4 && <OtherExpenses type="approver" /> }
...
ApprovalAddAfeRequest.propTypes = {
...
export default connect(mapStateToProps, { setUserType })(ApprovalAddAfeRequest);